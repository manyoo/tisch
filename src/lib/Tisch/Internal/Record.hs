...
-- | Instance required by 'Tisch.rawTableRW', for read-write purposes.
instance
    forall k p apbcs abs acs (a :: k) b c.
    ( PP.ProductProfunctor p
...
instance
  forall k (axs :: [(k,Type)]) (axs' :: [(k,Type)]).
...
instance
  forall k (a :: k) (x :: Type) (axs :: [(k,Type)]) (r :: Type).
...
instance
  forall k (x :: (k,Type)) (l :: [(k,Type)]) (l' :: [(k,Type)]) (z :: [(k,Type)]).
